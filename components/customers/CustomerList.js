  ...
  return (
    <>
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  className="px-3 py-2 text-xs font-medium text-text-muted hover:text-primary hover:bg-hover-bg rounded-lg transition-colors"
                >
                  Edit
                </button>
                <button
                  ...
                  className="px-3 py-2 text-xs font-medium text-text-muted hover:text-danger hover:bg-badge-red-bg rounded-lg transition-colors"
                >
                  Deactivate
                </button>
              </div>
      ...
      <ConfirmDialog
        ...
        onConfirm={async () => {
          await deleteCustomer.mutateAsync(deactivatingCustomer.id);
